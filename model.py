# Highly inspired from here: https://github.com/gaborfodor/wave-bird-recognition/blob/main/birds/pann.py
# The architecture: https://github.com/qiuqiangkong/audioset_tagging_cnn
...
def read_audio_fast(clip, sr_native, duration=30):
